...
function Publish(){
    const [publish, setPublish] = useState(List)
                        ...
                        publish && publish.map(publi =>(
                            <Col lg="4" md="6" sm="6">
                                <Card className="card-stats" >
                                    <Link to={`/admin/published/${publi.id}`} style={{textDecoration: 'none'}}>
                                        <CardBody>
                                            <Row>
                                                <Col md="4" xs="4">
                                                    <img className="img-public" src={publi.img}></img>
                                                </Col>
                                                
                                                <Col md="5" xs="5">
                                                    <p className="title">{publi.title}</p>
                                                    
                                                </Col>
                                                <Col>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" color={publi.color} fill="currentColor" class="bi bi-tags-fill" viewBox="0 0 16 16">
                                                        <path d="M2 2a1 1 0 0 1 1-1h4.586a1 1 0 0 1 .707.293l7 7a1 1 0 0 1 0 1.414l-4.586 4.586a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 2 6.586V2zm3.5 4a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z"/>
                                                        <path d="M1.293 7.793A1 1 0 0 1 1 7.086V2a1 1 0 0 0-1 1v4.586a1 1 0 0 0 .293.707l7 7a1 1 0 0 0 1.414 0l.043-.043-7.457-7.457z"/>
                                                    </svg>
                                                </Col>
